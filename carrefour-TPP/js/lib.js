...
(function ($) {
  $.fn.loadpage = function (action, opts) {
    ...
    var progressValue = 0;
    var loadHtml = ['<div class="mdLoading">', '    <div class="loadingBox">', '		 <div class="anibg"></div>', '        <img class="line2" src="images/load-pic.png">', '        <div class="progressBar">', '            <div class="progress js-bar" style="width:0"></div>', '        </div>', '    </div>', '</div>'].join('');
      ...
      return new Promise(function (resolve, reject) {
        if (!config.async) {
          ...
          queue.on("progress", function () {
            ...
            dCount.text(procValue + '%'); // dBar.css({
            // 	'width': procValue + '%'
            // });

            dAnibg.css({
              'transform': 'translateY(' + (100 - procValue) + '%)' // 'transform':'translateY(0%)'
